...
class VideoTracker(object):
    def __init__(self, cfg, args, video_path):
        ...
        self.deepsort = build_tracker(cfg, args, use_cuda=use_cuda)
    ...
    def __enter__(self):
        ...
        if self.args.save_path:
            ...
            self.save_video_path = os.path.join(
                self.args.save_path, f"results_{self.args.cnn_type}.avi"
            )
            self.save_results_path = os.path.join(
                self.args.save_path, f"results_{self.args.cnn_type}.txt"
            )
...
def parse_args():
    ...
    parser.add_argument(
        "--reidmodel_path",
        default="./model_vgg19.PTH",
        help="""path to the pretrained reid descriptor""",
    )
